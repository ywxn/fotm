...
namespace Fragsurf.Movement {
    public class SurfController {
                ...
                if (ladder != null) {
                    ...
                    if (allowClimb) {
                        ...
                        if (_surfer.moveData.climbingLadder == false) {
                            ...
                            _surfer.moveData.ladderDirection = 2f * direction.magnitude * -hit.normal;
        ...
        public void Crouch (ISurfControllable surfer, MovementConfig config, float deltaTime) {
            ...
            if (crouchLerp > 0.9f && !crouching) {
                ...
                if (_surfer.collider.GetType () == typeof (BoxCollider)) {
                    ...
                    // Capsule collider
                    CapsuleCollider capsuleCollider = (CapsuleCollider)_surfer.collider;
                    Vector3 point1 = capsuleCollider.center + 0.5f * capsuleCollider.height * Vector3.up;
                    Vector3 point2 = capsuleCollider.center + 0.5f * capsuleCollider.height * Vector3.down;
            ...
            if (!crouching)
                _surfer.moveData.viewTransform.localPosition = Vector3.Lerp (_surfer.moveData.viewTransformDefaultLocalPos, _surfer.moveData.viewTransformDefaultLocalPos * crouchingHeight + 0.5f * heightDifference * Vector3.down, crouchLerp);
            else
                _surfer.moveData.viewTransform.localPosition = Vector3.Lerp (_surfer.moveData.viewTransformDefaultLocalPos - 0.5f * heightDifference * Vector3.down, _surfer.moveData.viewTransformDefaultLocalPos * crouchingHeight, crouchLerp);
        ...
        void SlideMovement () {
            ...
            slideDirection += _deltaTime * slideSpeedCurrent * new Vector3 (groundNormal.x, 0f, groundNormal.z);
