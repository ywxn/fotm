...
public class PlayerAiming : MonoBehaviour
{
	...
	private void Update()
	{
		...
		// Input
		float xMovement = Input.GetAxisRaw("Mouse X") * SettingsValues.horizontalSens * SettingsValues.sensitivity;
		float yMovement = -Input.GetAxisRaw("Mouse Y") * SettingsValues.verticalSens  * SettingsValues.sensitivity;
